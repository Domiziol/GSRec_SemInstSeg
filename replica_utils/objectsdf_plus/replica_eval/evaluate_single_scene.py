...
if __name__ == "__main__":
    ...
    cmd = f"python cull_mesh.py --input_mesh {ply_file} --input_scalemat ./replica/scan{idx}/cameras.npz --traj ./replica/scan{idx}/traj.txt --output_mesh {cull_mesh_out}"
    print(cmd)
    os.system(cmd)

    cmd = f"python eval_recon.py --rec_mesh {cull_mesh_out} --gt_mesh ./replica/cull_GTmesh/{scan}.ply"
    print(cmd)
