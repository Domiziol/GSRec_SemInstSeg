...
def calc_3d_metric(rec_meshfile, gt_meshfile, align=False):
    ...
    if align:
        ...
        mesh_rec.export("rec_after_transform.ply")
    ...
    normal_comp *= 100
    normal_avg *= 100
    chamfer_l1 = 0.5*(accuracy_rec + completion_rec)

    print('Acc [cm]: ', accuracy_rec, 'Comp [cm]:', completion_rec, 'Precision [%]: ', precision_ratio_rec, 'Comp_ratio (recall)[%]: ', completion_ratio_rec,
           '\nF_score: ', fscore, 'Chamfer-L1 [cm]', chamfer_l1, 'Normal_acc: ', normal_acc, 'Normal_comp: ', normal_comp, 'Normal_avg: ',normal_avg)
