...
import numpy as np
from utils.graphics_utils import getWorld2View2, getProjectionMatrix, getinv_intrinsic

class Camera(nn.Module):
    def __init__(self, colmap_id, R, T, FoVx, FoVy, image, gt_alpha_mask,
                 image_name, depth, normal, mask, uid,
        ...
        self.inv_intrinsic = getinv_intrinsic(FoVx, FoVy, self.image_width, self.image_height).cuda()
